...
MAP_VARS = ["@type", "author", "citedBy", "correction", "curatedBy", "dateModified", "datePublished", "description", "doi", "duration", "funding", "identifier", "inComplianceWith", "instrument", "isBasedOn", "keywords", "license", "material", "measurementTechnique",
 "name", "protocolCategory", "relatedTo", "topicCategory", "url", "usedToGenerate"]
